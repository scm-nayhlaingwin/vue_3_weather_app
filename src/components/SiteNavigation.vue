        ...
        <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6">
            ...
            >
                <div class="text-black">
                    ...
                    <p>
                        If you no longer wish to track a city, simply select the city within the home page. At the bottom of the page, threre will be am option to delete the city.
                    </p>
                </div>
            </base-modal>
        </nav>
